...
- [`docker.sb`](https://github.com/eugene1g/agent-safehouse/compare/v0.11.1...v0.12.0#diff-2a99b527bf61c193bd84db192fc7c84224ff91cb9ecacede2c2672c45d2e5124): Anonymous image pulls now work. Authenticated pulls and `docker login` still need `--enable=keychain`.
