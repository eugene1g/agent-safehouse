...
if [ -x '/Applications/Visual Studio Code.app/Contents/MacOS/Code' ]; then
  exec '/Applications/Visual Studio Code.app/Contents/MacOS/Code' --no-sandbox -w "$@"
fi

if [ -x '/Applications/Visual Studio Code - Insiders.app/Contents/MacOS/Code - Insiders' ]; then
  exec '/Applications/Visual Studio Code - Insiders.app/Contents/MacOS/Code - Insiders' --no-sandbox -w "$@"
fi
