...
# Source Commit: e141b91617bcfee50ef4a70d22debd8ad9a2c2f5
...
PROFILE_KEYS=(
  ...
  "profiles/40-agents/__common.sb"
  "profiles/40-agents/aider.sb"
  "profiles/40-agents/amp.sb"
  "profiles/40-agents/auggie.sb"
  "profiles/40-agents/claude-app.sb"
  "profiles/40-agents/claude-code.sb"
  "profiles/40-agents/cline.sb"
  "profiles/40-agents/codex.sb"
  "profiles/40-agents/cursor-agent.sb"
  "profiles/40-agents/droid.sb"
  "profiles/40-agents/gemini.sb"
  "profiles/40-agents/opencode.sb"
  "profiles/40-agents/pi.sb"
  "profiles/50-integrations/1password.sb"
  "profiles/50-integrations/browser-native-messaging.sb"
  "profiles/50-integrations/cleanshot.sb"
  "profiles/50-integrations/cloud-credentials.sb"
  "profiles/50-integrations/docker.sb"
  "profiles/50-integrations/electron.sb"
  "profiles/50-integrations/git.sb"
  "profiles/50-integrations/keychain.sb"
  "profiles/50-integrations/macos-gui.sb"
  "profiles/50-integrations/scm-clis.sb"
  "profiles/50-integrations/spotlight.sb"
  "profiles/50-integrations/ssh.sb"
)
...
__SAFEHOUSE_EMBEDDED_profiles_30_toolchains_rust_sb__
      ;;
    "profiles/40-agents/__common.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents___common_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Common
;; Shared agent permissions for skills, agents, and guidance files.
;; Source: 40-agents/__common.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents___common_sb__
      ;;
    "profiles/40-agents/aider.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_aider_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Aider
;; Aider CLI binary, state, and config paths.
;; Source: 40-agents/aider.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_aider_sb__
      ;;
    "profiles/40-agents/amp.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_amp_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Amp
;; Amp CLI binary, state, and config paths.
;; Source: 40-agents/amp.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_amp_sb__
      ;;
    "profiles/40-agents/auggie.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_auggie_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Auggie
;; Auggie CLI binary, state, and config paths.
;; Source: 40-agents/auggie.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_auggie_sb__
      ;;
    "profiles/40-agents/claude-app.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_claude_app_sb__'
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_claude_app_sb__
      ;;
    "profiles/40-agents/claude-code.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_claude_code_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Claude Code
;; Claude Code CLI binary, state, config, and MCP integration paths.
;; Source: 40-agents/claude-code.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_claude_code_sb__
      ;;
    "profiles/40-agents/cline.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_cline_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Cline
;; Cline CLI binary, state, and config paths.
;; Source: 40-agents/cline.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_cline_sb__
      ;;
    "profiles/40-agents/codex.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_codex_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Codex
;; Codex CLI binary, state, and config paths.
;; Source: 40-agents/codex.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_codex_sb__
      ;;
    "profiles/40-agents/cursor-agent.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_cursor_agent_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Cursor
;; Cursor CLI binary, state, config, and app bundle paths.
;; Source: 40-agents/cursor-agent.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_cursor_agent_sb__
      ;;
    "profiles/40-agents/droid.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_droid_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Droid
;; Droid CLI binary, Factory helpers, state, and config paths.
;; Source: 40-agents/droid.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_droid_sb__
      ;;
    "profiles/40-agents/gemini.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_gemini_sb__'
;; ---------------------------------------------------------------------------
;; Agent: Gemini
;; Gemini CLI binary, state, and config paths.
;; Source: 40-agents/gemini.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_gemini_sb__
      ;;
    "profiles/40-agents/opencode.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_opencode_sb__'
;; ---------------------------------------------------------------------------
;; Agent: openCode
;; openCode CLI binary, state, and config paths.
;; Source: 40-agents/opencode.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_opencode_sb__
      ;;
    "profiles/40-agents/pi.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_40_agents_pi_sb__'
;; ---------------------------------------------------------------------------
;; Agent: PI
;; PI CLI binary, state, and config paths.
;; Source: 40-agents/pi.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_40_agents_pi_sb__
      ;;
    "profiles/50-integrations/1password.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_1password_sb__'
;; ---------------------------------------------------------------------------
;; Integration: 1Password
;; 1Password desktop app and CLI agent socket access.
;; Source: 50-integrations/1password.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_1password_sb__
      ;;
    "profiles/50-integrations/browser-native-messaging.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_browser_native_messaging_sb__'
;; ---------------------------------------------------------------------------
;; Integration: Browser Native Messaging
;; Chromium native messaging host registration and extension detection.
;; Source: 50-integrations/browser-native-messaging.sb
;; ---------------------------------------------------------------------------

;; Three things are needed per browser:
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_browser_native_messaging_sb__
      ;;
    "profiles/50-integrations/cleanshot.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_cleanshot_sb__'
;; ---------------------------------------------------------------------------
;; Integration: CleanShot
;; Read access to CleanShot screenshot/recording media for pasting into agents.
;; Source: 50-integrations/cleanshot.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_cleanshot_sb__
      ;;
    "profiles/50-integrations/cloud-credentials.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_cloud_credentials_sb__'
;; ---------------------------------------------------------------------------
;; Integration: Cloud Credentials
;; Cloud provider CLI/SDK credential, config, and cache access.
;; Source: 50-integrations/cloud-credentials.sb
;; ---------------------------------------------------------------------------
...
(allow file-read* file-write*
    ...
    ;; (home-subpath "/.azure")         ;; Azure CLI config/credentials (uncomment if needed).
)
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_cloud_credentials_sb__
      ;;
    "profiles/50-integrations/docker.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_docker_sb__'
;; ---------------------------------------------------------------------------
;; Integration: Docker
;; Docker daemon socket access for container operations. High-risk.
;; Source: 50-integrations/docker.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_docker_sb__
      ;;
    "profiles/50-integrations/electron.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_electron_sb__'
;; ---------------------------------------------------------------------------
;; Integration: Electron
;; Chromium/Electron runtime: GPU, Metal shaders, crashpad, and WebView.
;; Source: 50-integrations/electron.sb
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_electron_sb__
      ;;
    "profiles/50-integrations/git.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_git_sb__'
;; ---------------------------------------------------------------------------
;; Integration: Git
;; Git client configuration and XDG config directory access.
;; Source: 50-integrations/git.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_git_sb__
      ;;
    "profiles/50-integrations/keychain.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_keychain_sb__'
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_keychain_sb__
      ;;
    "profiles/50-integrations/macos-gui.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_macos_gui_sb__'
;; ---------------------------------------------------------------------------
...
;; Source: 50-integrations/macos-gui.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_macos_gui_sb__
      ;;
    "profiles/50-integrations/scm-clis.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_scm_clis_sb__'
;; ---------------------------------------------------------------------------
;; Integration: SCM CLIs
;; GitHub CLI (gh) and GitLab CLI (glab) config, cache, and state access.
;; Source: 50-integrations/scm-clis.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_scm_clis_sb__
      ;;
    "profiles/50-integrations/spotlight.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_spotlight_sb__'
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_spotlight_sb__
      ;;
    "profiles/50-integrations/ssh.sb")
      cat <<'__SAFEHOUSE_EMBEDDED_profiles_50_integrations_ssh_sb__'
;; ---------------------------------------------------------------------------
;; Integration: SSH
;; SSH agent sockets, system config, key deny rules, and safe config access.
;; Source: 50-integrations/ssh.sb
;; ---------------------------------------------------------------------------
...
__SAFEHOUSE_EMBEDDED_profiles_50_integrations_ssh_sb__
      ;;
    *)
      return 1
      ;;
