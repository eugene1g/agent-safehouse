...
# Embedded Profiles Last Modified (UTC): 2026-03-12T20:36:35Z
...
;; $$require=55-integrations-optional/chromium-headless.sb,55-integrations-optional/chromium-full.sb$$
;; $$exec-env-default=PLAYWRIGHT_MCP_SANDBOX=false$$
;; ---------------------------------------------------------------------------

;; This profile emits no direct SBPL rules. It exists to require the shared
;; Chromium Full policy for Chrome-family channels and to inject
...
safehouse_project_version_embedded="0.3.1"
...
enable_playwright_chrome_integration=0
...
supported_enable_features="docker, kubectl, macos-gui, electron, chromium-headless, chromium-full, playwright-chrome, ssh, spotlight, cleanshot, clipboard, 1password, cloud-credentials, agent-browser, browser-native-messaging, shell-init, process-control, lldb, xcode, all-agents, all-apps, wide-read"
