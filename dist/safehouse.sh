...
# Embedded Profiles Last Modified (UTC): 2026-09-14T16:00:25Z
...
(allow network-outbound
    ...
    (remote unix-socket (home-subpath "/.config/herdr/sessions"))   ;; named-session sockets: ~/.config/herdr/sessions/<name>/herdr.sock.
)
