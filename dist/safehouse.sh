...
# Embedded Profiles Last Modified (UTC): 2026-07-02T12:13:43Z
...
safehouse_project_version_embedded="0.10.1"
...
policy_dist_append_preassembled_fixed_before_home_content() {
...
policy_dist_append_preassembled_fixed_before_home() {
  if [[ "${policy_req_offline:-0}" -eq 1 ]]; then
    policy_dist_append_preassembled_fixed_before_home_content | policy_render_strip_network_allow_rules_stream >&"$policy_render_target_fd"
  else
    policy_dist_append_preassembled_fixed_before_home_content >&"$policy_render_target_fd"
  fi
}

policy_dist_append_preassembled_fixed_after_home_content() {
...
policy_dist_append_preassembled_fixed_after_home() {
  if [[ "${policy_req_offline:-0}" -eq 1 ]]; then
    policy_dist_append_preassembled_fixed_after_home_content | policy_render_strip_network_allow_rules_stream >&"$policy_render_target_fd"
  else
    policy_dist_append_preassembled_fixed_after_home_content >&"$policy_render_target_fd"
  fi
}

policy_dist_append_preassembled_core_integrations_content() {
...
policy_dist_append_preassembled_core_integrations() {
  if [[ "${policy_req_offline:-0}" -eq 1 ]]; then
    policy_dist_append_preassembled_core_integrations_content | policy_render_strip_network_allow_rules_stream >&"$policy_render_target_fd"
  else
    policy_dist_append_preassembled_core_integrations_content >&"$policy_render_target_fd"
  fi
}
