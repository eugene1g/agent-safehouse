...
# Embedded Profiles Last Modified (UTC): 2026-08-28T19:09:45Z
...
(deny file-read* file-write*
    ...
    ;; Legacy secret keyring (GnuPG < 2.1). Auto-migrated to private-keys-v1.d
    ;; on upgrade, but may still be present/non-empty on old or restored setups.
