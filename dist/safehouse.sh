...
# Embedded Profiles Last Modified (UTC): 2026-09-04T12:59:17Z
...
policy_embedded_supported_enable_features="1password, agent-browser, browser-native-messaging, chromium-full, chromium-headless, cleanshot, clipboard, cloud-credentials, cloud-storage, docker, electron, gpg, herdr, keychain, kubectl, launch-services, lldb, macos-gui, microphone, playwright-chrome, process-control, shell-init, spotlight, ssh, vscode, xcode, all-agents, all-apps, wide-read"
