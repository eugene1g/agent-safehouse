...
# Embedded Profiles Last Modified (UTC): 2026-03-18T20:04:55Z
...
;; Current fnm releases commonly pair those shims with runtimes under one of
;; the default fnm install roots above, which the Node toolchain block grants
;; read/write.
(allow file-read-metadata
