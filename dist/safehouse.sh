...
# Embedded Profiles Last Modified (UTC): 2026-02-11T10:57:41Z
...
(allow file-read*
    ...
    (data-home-subpath "/Library/Application Support/CrashReporter")
    (home-subpath "/Library/Spelling")
    (data-home-subpath "/Library/Spelling")
...
(allow file-read-metadata
    ...
    (data-home-subpath "/Library/Mobile Documents")
...
;; - Kilo CLI stores config, logs, sessions, and commands under ~/.kilocode
;; - CLI reads VS Code extension global storage (for example global custom modes)
...
(allow file-read*
    ...
    (data-home-subpath "/Library/Application Support/Code/User/globalStorage/kilocode.kilo-code")
)
...
(allow file-read* file-write*
    ...
    (data-home-subpath "/Library/Application Support/Microsoft/DeveloperTools")
    (home-subpath "/Library/Application Support/com.openai.chat/app_pairing_extensions")
    (data-home-subpath "/Library/Application Support/com.openai.chat/app_pairing_extensions")
    (home-subpath "/.vscode")
    ...
    (data-home-literal "/Library/Preferences/com.microsoft.VSCode.plist")
    (home-literal "/Library/Preferences/com.microsoft.VSCodeInsiders.plist")
    (data-home-literal "/Library/Preferences/com.microsoft.VSCodeInsiders.plist")
