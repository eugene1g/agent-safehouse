...
# Embedded Profiles Last Modified (UTC): 2026-03-15T16:29:00Z
...
;; and user defaults under ~/.agent-browser. Its default macOS Chrome engine
;; needs the shared full-browser Chromium launch allowances.
