...
# Embedded Profiles Last Modified (UTC): 2026-03-18T19:48:39Z
...
(allow file-read* file-write*
    ...
    (home-subpath "/.nvm")
    (home-subpath "/.fnm")
    (home-subpath "/.local/share/fnm")  ;; Current fnm default install root for managed Node runtimes and package manager payloads.
...
;; Current fnm releases commonly pair those shims with runtimes under
;; ~/.local/share/fnm, which the Node toolchain block above grants read/write.
(allow file-read-metadata
...
safehouse_project_version_embedded="0.5.2"
